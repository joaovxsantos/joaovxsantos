...
| [Dashboard Mars](https://github.com/joaovxsantos/dashboard-mars) | Painel administrativo construído com Next.js para gestão de produtos, pedidos e clientes, consumindo o design-system-mars — um design system próprio com suporte a tema claro/escuro. | React, TypeScript, Next.JS, SCSS |
